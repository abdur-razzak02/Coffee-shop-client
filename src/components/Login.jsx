    ...
    <div className="py-10 lg:py-20 px-5 md:px-0 bg-base-200 flex justify-center items-center">
      <div className="bg-white p-5 lg:p-10 rounded-lg shadow-lg max-w-sm w-full">
        <div className="relative mb-8">
          <svg
            className="absolute top-0 left-0 w-full h-40 text-blue-300 -z-10"
          ...
          <h2 className="text-3xl font-semibold text-center text-coffee font-rancho">
            Login
          </h2>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex justify-between mb-6">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember" className="ml-1 text-sm text-gray-600">
                Remember me
              </label>
            </div>
          ...
          {errorMessage && (
            <p className="py-3 text-center text-red-500">{errorMessage}</p>
          )}
